...
import { _ as _sfc_main$1 } from "../va-time-picker/VaTimePicker.vue_vue_type_script_setup_true_lang.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const timePickerProps = filterComponentProps(extractComponentProps(_sfc_main$1));
    __expose({
      isFocused,
      isValid,
      value: valueComputed,
...
//# sourceMappingURL=VaTimeInput.vue_vue_type_script_setup_true_lang.mjs.map

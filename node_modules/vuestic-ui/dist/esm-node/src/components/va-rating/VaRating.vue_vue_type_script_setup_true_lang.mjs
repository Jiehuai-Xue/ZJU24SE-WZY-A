...
import { _ as _sfc_main$1 } from "./components/VaRatingItem/VaRatingItem.vue_vue_type_script_setup_true_lang.mjs";
import { _ as _sfc_main$2 } from "./components/VaRatingItemNumberButton.vue_vue_type_script_setup_true_lang.mjs";
...
const VaRatingItemPropsDeclarations = extractComponentProps(_sfc_main$1, ["modelValue", "itemNumber"]);
const VaRatingItemNumberButtonPropsDeclarations = extractComponentProps(_sfc_main$2, ["modelValue", "itemNumber"]);
            ...
            return openBlock(), createBlock(_sfc_main$1, mergeProps({
              ...
              default: withCtx(({ value, onClick }) => [
                renderSlot(_ctx.$slots, "item", normalizeProps(guardReactiveProps({ value, onClick, index: itemNumber })), () => [
                  _ctx.$props.numbers ? (openBlock(), createBlock(_sfc_main$2, mergeProps({ key: 0 }, unref(VaRatingItemNumberButtonProps), {
                    "model-value": value,
...
//# sourceMappingURL=VaRating.vue_vue_type_script_setup_true_lang.mjs.map

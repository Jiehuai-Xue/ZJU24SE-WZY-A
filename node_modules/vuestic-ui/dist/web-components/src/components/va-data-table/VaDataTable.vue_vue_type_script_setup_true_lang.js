...
const _hoisted_7 = ["onClick", "onDblclick", "onContextmenu"];
const _hoisted_8 = {
  key: 0,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    useCssVars((_ctx) => ({
      "367d0050": unref(CSSVariables).selectedColor,
      "3ebeb337": unref(CSSVariables).hoverColor,
      "5c377636": unref(CSSVariables).tableHeight,
      "b48303ee": unref(CSSVariables).theadBg,
      "ba2f5dd2": unref(CSSVariables).tfootBg,
      "00da4bfc": gridColumnsCount.value
    }));
                ...
                createElementVNode("tbody", _hoisted_2, [
                  ...
                  createVNode(TransitionGroup, {
                    ...
                    default: withCtx(() => [
                      ...
                      ])) : showNoDataFilteredHtml.value ? (openBlock(), createElementBlock("tr", _hoisted_5, [
                        createElementVNode("td", {
                          class: "va-data-table__table-td no-data",
                          colspan: "99999",
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(renderBuffer, (row, index) => {
                        return openBlock(), createElementBlock(Fragment, {
                          ...
                          row.isExpandableRowVisible ? (openBlock(), createElementBlock("td", {

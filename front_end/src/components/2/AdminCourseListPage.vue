        ...
        <div class="content">
            ...
            <div class="tool-detail" v-if="action==1">
                <div style="display: flex; flex-direction: row;">
                    <div style="width: 35%;">
                        <div class="add-item">
                            ...
                            <input v-model="new_course.name">
                        </div>
                        <div class="add-item">
                            <div class="add-item-name">学分 </div>
                            <input v-model="new_course.credit">
                        </div>
                        <div class="add-item">
                            <div class="add-item-name">教师ID </div>
                            <input v-model="new_course.teacherId">
                        </div>

                        <div class="add-item">
                            <div class="add-item-name">教室ID </div>
                            <input v-model="new_course.classroomId">
                        </div>
                        <div class="add-item">
                            <div class="add-item-name">课程容量</div>
                            <input v-model="new_course.capacity">
                        </div>
                        <div class="add-item">
                            <div class="add-item-name">是否必修</div>
                            <VaRadio v-model="new_course.compulsory"
                                :options="[
                                {
                                    text: '是',
                                    value: true,
                    ...
                    <div style="width: 65%;">
                        <div class="add-item" style="display: flex; flex-direction: column;">
                            ...
                            <div style="display: flex; flex-direction: row;">
                                <VaOptionList v-model="time" :options="['周一1', '周一2', '周一3', '周一4','周一5', '周一6', '周一7', '周一8']" style="margin-right: 30px;"/>
                                <VaOptionList v-model="time" :options="['周二1', '周二2', '周二3', '周二4','周二5', '周二6', '周二7', '周二8']" style="margin-right: 30px;"/>
                                <VaOptionList v-model="time" :options="['周三1', '周三2', '周三3', '周三4','周三5', '周三6', '周三7', '周三8']" style="margin-right: 30px;"/>
                                <VaOptionList v-model="time" :options="['周四1', '周四2', '周四3', '周四4','周四5', '周四6', '周四7', '周四8']" style="margin-right: 30px;"/>
                                <VaOptionList v-model="time" :options="['周五1', '周五2', '周五3', '周五4','周五5', '周五6', '周五7', '周五8']" style="margin-right: 30px;"/>
                            </div>
                ...
                <div class="add-item">
                            ...
                            <input v-model="new_course.AssessmentMethod" style="width: 84%;">
                        </div>
                <div class="add-item">
    ...
    export default {
        ...
        methods:{
            ...
            comfirmAdd(){
                ...
                const body = {id: this.uid, course: this.new_course};
                console.log(body);
            ...
            comfirmSelect(){
                const body = {uid: this.uid, data: this.condition};
                console.log(body);
            ...
            showDetail(oid){
                ...
                this.$router.push({path:`/admin/course/detail/${oid}`,});
            }
        },
        mounted(){
            this.getCoursesDefault();

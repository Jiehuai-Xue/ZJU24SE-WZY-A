    ...
    <div class="container">
        ...
        <div class="content">
                ...
                <div style="display: flex;">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
                            <div class="add-item">
                                ...
                                <input v-model="new_classroom.campus">
                            </div>
                            <div class="add-item">
                                <div class="add-item-name">位置 </div>
                                <input v-model="new_classroom.name">
                            </div>
                            <div class="add-item">
                                <div class="add-item-name">容量</div>
                                <input v-model="new_classroom.capacity">
                            </div>
                            <div class="add-item">
                    ...
                    <div class="va-table-responsive">
                        ...
                        <tbody>
                            ...
                            <td v-if="selected_classroom.id == classroom.id">
                                <VaButton size="small" color="danger" @click="deleteSelected(classroom)">删除</VaButton>
                            </td>
                            </tr>
                        </tbody>
                        </table>
            ...
            <VaModal
                v-model="showModal"
                ok-text="确定"
                :beforeOk="comfirmDeleteSelected"
    ...
    export default {
        ...
        methods:{
            ...
            comfirmDeleteSelected(){
                const body = {uid: this.uid, oid: this.selected_classroom.id};
